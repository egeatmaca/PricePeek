...
class AnalysisController:
    def scrape(self, marketplace_str: str, search_query: str) -> None:
        marketplace = None
        ...
        print(f"Started scraping {search_query} on {marketplace}...")
        logging.info(f"Started scraping {search_query} on {marketplace}...")

        scraper = ScraperFactory().create_scraper(marketplace)
        product_infos = scraper.get_product_infos(search_query)

        print(f"Finished scraping {search_query} on {marketplace}")
        logging.info(f"Finished scraping {search_query} on {marketplace}")
